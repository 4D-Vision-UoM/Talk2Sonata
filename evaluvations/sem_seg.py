...
if __name__ == "__main__":
    ...
    coords_aligned[:, [1, 2]] = coords_aligned[:, [2, 1]]
    ...
    # Save output
    output_dir = "demo_outputs/sem_seg"
    os.makedirs(output_dir, exist_ok=True)
    o3d.io.write_point_cloud(f"{output_dir}/sem_seg.pcd", pcd)
    print(f"Saved: {output_dir}/sem_seg.pcd")
